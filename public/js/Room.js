    ...
    function share() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                let message = {
                    email: '',
                    subject: 'Please join our Rogachat Video Chat Meeting',
...
function showAbout() {
    ...
    Swal.fire({
        ...
        <br/>
        <div id="about">
            <b><a href="https://rogachat.com" class="umami--click--github" target="_blank">Project by ROgachat</a></b> project
            <br/><br />
            <button class="pulsate umami--click--sponsors" onclick="window.open('https://rogachat.com')"><i class="fas fa-heart"></i> Support</button>
            <br /><br />
        </div>
        `,
        showClass: {
